...
<body class="bg-[url('../assets/img/blob-scene-haikei.svg')] bg-cover">
  <div>
    <div class="flex flex-row items-center justify-center">
      <div class="flex flex-col items-center justify-center h-screen">
        <div
          ...
          <img src="../assets/img/bg.jpg" alt="" class="m-5 rounded-lg" />
        </div>
      </div>
      <div class="flex flex-col items-center justify-center h-screen">
        <div class="w-[20rem] max-w-md p-6 bg-white backdrop-blur-xl bg-opacity-5 shadow-2xl drop-shadow-md rounded-lg">
          ...
          <form class="flex flex-col">
            ...
            <a href="register.html"
              class="text-center mb-[3rem] transition ease-in-out duration-100 hover:text-purple-500">Register Now!</a>
          </form>
        </div>
      </div>
    </div>
