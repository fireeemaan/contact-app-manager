...
<body class="bg-[url('../../assets/img/wavy-lines.svg')] bg-cover pt-8 pb-28">
        ...
        <div
          ...
          <div class="flex flex-col">
            ...
            <form action="../../controller/DashboardController.php?action=update" method="post"
              ...
              <input id="phone-field" type="text" placeholder="Name" name="name" class="py-2 px-3 my-3 rounded-lg"
                required>
              <button type="submit"
          ...
          <table class="w-[70vw] rounded-lg">
            ...
            <tbody class="bg-white text-left">
              ...
              <?php foreach ($result as $index => $contact): ?>
                ...
                <tr class="contact-row" id="cr-<?= $contact['id'] ?>">
                  <td><?= $index + 1 ?></td>
                  <td><?= $contact['phone'] ?></td>
                  <td><?= $contact['name'] ?></td>
                  <td>
                    <div class="flex flex-row gap-2">
                      <button class="edit-btn p-2 bg-blue-500 rounded-lg hover:bg-blue-600"><img
                          src="../../assets/img/edit-icon.svg"></button>
                      <form action="../../controller/DashboardController.php?action=delete" method="post">
                        <input type="hidden" name="id_contact" value="<?= $contact['id'] ?>">
                        <button class="p-2 bg-red-500 rounded-lg mr-2 hover:bg-red-600" type="submit"><img
